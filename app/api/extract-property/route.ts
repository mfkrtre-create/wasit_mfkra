...
- For commercial/office building ads, put "مساحة الأرض" in area, "المسطحات البنائية" in builtUpArea, "عدد الأدوار" in floors, "أدوار بدروم" in basementFloors, parking count per basement in parkingPerBasement, total parking capacity in parkingTotal, "عرض استئجار" in rentalOfferAmount, "غير مؤجر حالياً" or similar in occupancyStatus, finishing/readiness wording in finishing, hotel/headquarters conversion wording in conversionPotential, and disposition/real-estate transaction tax wording in transferTaxNote.
